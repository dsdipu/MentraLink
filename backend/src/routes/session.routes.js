...
router.get("/next", authorize("ADMIN", "MENTOR", "STUDENT"), getNextSession);

// NOTE: these must come BEFORE "/:id", otherwise Express treats "me"/"mentor" as an :id param
router.get("/me", authorize("STUDENT"), getMySessions);
router.get("/mentor/me", authorize("MENTOR"), getMyMentorSessions);
